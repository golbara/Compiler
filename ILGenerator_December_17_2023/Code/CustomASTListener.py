...
class ASTListener(AssignmentStatementListener):
    ...
    def exitStatement(self, ctx: AssignmentStatementParser.StatementContext):
        ...
        # print("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&7")
        # print("in statement " , ctx.value_attr.value)
    ...
    #     # if(opertor == "else" or opertor == "then"):
    #         # print("start!!!!!!!!!!!!!!!!!!!!!!!!!")
    ...
    #         # print("^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^")
    #         # print(next_child.getText())
    #         if hasattr(next_child, "value_attr"):
    #             # if (opertor == "else" or opertor):
    #                 # print("**********************************")
    #                 # print("i = ", i, "count = ", no_children,next_child.getText())
    #                 # print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    #                 # print(next_child.value_attr)
    #                 # print("i = ", i, "count = ", no_children, next_child.value_attr)
    ...
    #         value=opertor, child=first_child, brother=None
    #     )
    #     tree_node.value_attr = sub_tree_pntr
    #     print("tree_node_val",tree_node.value_attr.value)
    ...
    def make_AST_subtree(self, tree_node, opertor):
        ...
        tree_node.value_attr = sub_tree_pntr
        self.ast.root = sub_tree_pntr
        return sub_tree_pntr
    def exitIfst(self, ctx: AssignmentStatementParser.IfstContext):
        if ctx.getChildCount()>4 :
            elsePntr = self.ast.make_node(
                value="\"else:\"", child=None, brother=ctx.getChild(7).value_attr
            )
        thenCompoundPntr = self.make_AST_subtree(tree_node=ctx.compoundst(0),opertor="block")
    ...
    def exitCond(self, ctx: AssignmentStatementParser.CondContext):
        ...
        self.make_AST_subtree(tree_node=ctx, opertor=operator)
